...
class NodeLauncher(Node):
    ...
    def __init__(self):
        ...
        self.string_trayectoria= 'ros2 run trayectories move_l_gcode --ros-args -p factor_escala:=0.08 -p trayectoria_dato:=generated_gcode_medio_estrella_poses_v3.gcode'
