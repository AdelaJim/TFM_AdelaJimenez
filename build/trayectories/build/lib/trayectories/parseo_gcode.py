...
def parseo_gcode(file_path):
    ...
    return poses, Vel_impresion[0], Temp_cama, Temp_extrusor, motores_on 
    


### IMPORTANTE: para que funciona correctamente la lectura del gcode, debe finalinzar con una ultima linea de la forma: 
### ; End G-code
### En caso contrario no se guarda correctamente el vector de velocidades de impresion.
